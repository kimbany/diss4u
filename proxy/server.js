...
이전에 만든 곡과 다른 색을 내기 위해 이번 곡은 아래 6가지를 반드시 따라라.
...
이 노래는 Hook 중심의 1분 이하 숏폼 밈송이다.
Verse는 짧게, Hook은 길고 강하게. ★ 어떤 경우에도 Hook이 Verse보다 길어야 한다.
...
* Pre-Hook은 기본적으로 생략. 넣어도 반드시 1줄만.
* 전체 가사는 9~14줄 이내.
* Hook 안에서 메인 A라인은 최소 3회 이상 반복(이상적 4회).
