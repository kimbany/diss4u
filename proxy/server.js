...
2. 입력된 [키워드]를 "뜻 그대로" 정확히 해석해서 전부 자연스럽게 녹여야 한다.
   ...
   ★★ 키워드의 "단어 자체"를 가사 안에 그대로 등장시켜라. 동의어·풀어쓰기·비유로 바꾸지 마라.
     - 모든 입력 키워드는 최소 1회 이상 가사에 "원형 그대로" 나와야 한다.
     - 나쁜 예(변형): "발냄새" → "발 향기", "쿰쿰한 발", "지린내" (단어를 바꿈)
       좋은 예(원형 유지): "쟤 발냄새 진짜 무기야", "발냄새 한 방에 KO"
     - 나쁜 예: "늦잠" → "아침에 못 일어남" / "ADHD" → "산만함"
       좋은 예: "또 늦잠이야 너", "ADHD 풀가동 모드"
     - 키워드 원형이 문장에 어색하면 조사/어미만 살짝 붙여 자연스럽게 만들어라. 단어 자체는 바꾸지 마라.
