...
★ 흔한 클리셰 (이런 비유 절대 금지):
  ...
  · '못생겼다' / '못난이' / '얼굴' → **거울** 비유 금지 (거울을 보고, 거울이 깨지고, 거울 앞에서…)
    대신: 사진/셀카 자세, 보정 앱, 친구의 미묘한 반응, 캡처 안 됨, 정면샷 회피 등
  · '키 작은' → 의자/까치발/높은 곳에 손 안 닿음 금지
    대신: 단체 사진 맨 앞, 카운터 너머 안 보임, 키 큰 친구 옆 비교 등
  · '잠 많은' → 알람 시계/베개 금지
    대신: 회의 중 꾸벅, 카톡 답장 늦음, 점심 빼먹음, 약속 1시간 늦음 등
  · '많이 먹는' → 냉장고/통통한 배 금지
    대신: 회식 마지막까지, 다이어트 선언 반복, 야식 전화 익숙, 영수증 길이 등
  · '게으른' → 침대/이불 금지
    대신: 늘 같은 자리 카페, 배달 단골, 미루기 챔피언, 작년 계획표 등
