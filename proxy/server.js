...
가사는 약 40~50초 분량으로 작성해라.

인트로는 작성하지 마라.
처음부터 바로 대상의 특징이나 행동이 드러나는 Verse로 시작해라.
...
[Hook]
가장 킹받는 별명이나 문장을 중독성 있게 반복한다.
키워드를 그대로 반복하지 말고,
놀리는 별명, 반복되는 행동, 친구들이 맨날 하는 놀림 말투로 변형해라.

[Outro]
마지막에 한 방 먹이는 짧은 마무리를 넣어라.
노래가 갑자기 끊기는 느낌이 아니라,
짧게 끝맺는 느낌이 있어야 한다.

2절, 긴 브릿지, 긴 엔딩은 작성하지 마라.

전체 흐름은:
상황 제시 → 놀림 강화 → 중독성 있는 Hook → 짧은 마무리
