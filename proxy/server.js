...
7. ★ 이번 곡 무대(장면): "${seed.scene}"
   → 이 상황/장소를 가사의 주요 배경으로 삼아 키워드를 풀어라.
   → 같은 키워드라도 이 무대가 다르면 완전히 다른 가사가 나와야 한다.
   → 뻔한 소재(거울·셀카 등)로 도망가지 말고, 이 무대 안에서 벌어지는 구체적 장면을 그려라.

위 시드는 강제 규칙이다. 시드를 무시하고 평균적인(=이전과 비슷한) 곡을 만들면 안 된다.
